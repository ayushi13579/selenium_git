...
public class upload {
	...
	public void openbrowser () {
		driver = upload.getDriver(browser);
	}
	...
	public void closebrowser() {
		...
		public void testcase1() throws InterruptedException {
			...
			driver.get("http://local:8083/TestMeApp/login.htm");
					...
					driver.navigate().to("http://www.simpleimageresizer.com/");
					...
					System.out.println(“Name of the cookie: “+temp.getName()+” and its value : “+temp.getValue()
					+” get domain : “+temp.getDomain()+” get path : “+temp.getPath()+
					“and its expiry date: “+temp.getExpiry()+” Cookie is secured : “+temp.isSecure()
					);
